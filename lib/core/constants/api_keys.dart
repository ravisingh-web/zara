...
class ApiKeys {
  ...
  // ── Gemini Brain Models — sirf 4 ─────────────────────────────────────────
  static const List<Map<String, String>> gemModels = [
    {'id': 'gemini-2.5-flash',      'name': 'Gemini 2.5 Flash',      'desc': 'Best balance — fast + smart'},
    {'id': 'gemini-2.5-flash-lite', 'name': 'Gemini 2.5 Flash Lite', 'desc': 'Lightest — battery saver'},
    {'id': 'gemini-2.0-flash',      'name': 'Gemini 2.0 Flash',      'desc': 'Stable workhorse'},
    {'id': 'gemini-2.0-flash-lite', 'name': 'Gemini 2.0 Flash Lite', 'desc': 'Fastest responses'},
  ];
  ...
  // ── Gemini TTS Voices (jab ElevenLabs OFF ho) ────────────────────────────
  static const List<Map<String, String>> geminiTtsVoices = [
    {'id': 'Aoede',  'name': 'Aoede  — Warm female'},
  ...
  static const _defGem   = 'gemini-2.5-flash';
